...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container">
        ...
        <br /><br />
         ...
         <asp:Button ID="editCar_button" runat="server" Text="Save Changes" BorderStyle="Solid" BackColor="Black" CssClass="btn" Font-Size="Large" ForeColor="White" OnClick="editCar_button_Click" Width="242px" />
         &nbsp;&nbsp;&nbsp;
         <asp:Button ID="back_button" runat="server" Text="Back" BorderStyle="Solid" BackColor="Black" CssClass="btn" Font-Size="Large" ForeColor="White" CausesValidation="False" OnClick="back_button_Click" Width="127px" />

...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="display:inline-block; vertical-align:top">
        ...
        <h4>Are you sure you want to delete a car?</h4>

        <asp:Button ID="delete_button" runat="server" Text="Delete" Font-Bold="False" BorderStyle="Solid" BackColor="Black" CssClass="btn" Font-Size="Large" ForeColor="White" Height="45px" Width="118px" OnClick="delete_button_Click"/>
        &nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="back_button" runat="server" Text="Back" Font-Bold="False" BorderStyle="Solid" BackColor="Black" CssClass="btn" Font-Size="Large" ForeColor="White" Height="43px" Width="114px" CausesValidation="False" OnClick="back_button_Click"/>
        <br />
    </div>

    ...
    <hr />
     ...
     <div class="container">
        ...
        <br />
         ...
         <asp:Button ID="addCar_button" runat="server" Text="Add Car" BorderStyle="Solid" BackColor="Black" CssClass="btn" Font-Size="Large" ForeColor="White" OnClick="addCar_button_Click" Width="148px" />
         &nbsp;&nbsp;&nbsp;
         <asp:Button ID="back_button" runat="server" Text="Back" BorderStyle="Solid" BackColor="Black" CssClass="btn" Font-Size="Large" ForeColor="White" CausesValidation="False" OnClick="back_button_Click" Width="149px" />

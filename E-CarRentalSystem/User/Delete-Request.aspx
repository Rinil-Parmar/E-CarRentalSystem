...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="display:inline-block; vertical-align:top">
        ...
        <h4>Are you sure you want to delete a request ?</h4>

        <asp:Button ID="delete_button" runat="server" Text="Delete" Font-Bold="False" BorderStyle="Solid" BackColor="Black" CssClass="btn" Font-Size="Large" ForeColor="White" Height="40px" Width="109px" OnClick="delete_button_Click"/>
        &nbsp;&nbsp;&nbsp;&nbsp;

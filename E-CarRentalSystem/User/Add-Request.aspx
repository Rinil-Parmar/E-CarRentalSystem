<%@ Page Title="Add-Request Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Add-Request.aspx.cs" Inherits="E_CarRentalSystem.User.Add_Request" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="display:inline-block; vertical-align:top">
        ...
        <asp:Button ID="request_button" runat="server" Text="Make Request" Font-Bold="False" BorderStyle="Solid" BackColor="Black" CssClass="btn" Font-Size="Large" ForeColor="White" Height="40px" Width="204px" OnClick="request_button_Click" />
        <br />
    </div>
